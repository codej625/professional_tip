...
```
개발자들이라면 대부분 한 번씩 들어봤을 용어이지만
전부 다른 개념을 갖고 있다.

정확한 용어와 의미를 이해하기 위해 정리해 보았다.
```
